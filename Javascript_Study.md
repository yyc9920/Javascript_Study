...
- 디버깅
  - JavaScript를 html 파일 내부에 포함시킨 후 브라우저의 개발자 도구를 이용해 디버깅이 가능하다.
    ...
    ```
    <a><img src="capture1.png" hspace="10" vspace="6" width="400"></a>
    <a><img src="capture2.png" hspace="10" vspace="6" width="400"></a>

    - 위 html 파일을 브라우저에서 실행했을 때의 모습.

    <a><img src="capture3.png" hspace="10" vspace="6" width="400"></a>
